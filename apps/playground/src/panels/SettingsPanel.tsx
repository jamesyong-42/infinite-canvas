...
export function SettingsPanel({ engine, onClose }: SettingsPanelProps) {
	...
	return (
		<div className="absolute bottom-14 left-4 z-50 w-64 rounded-lg border border-neutral-200 bg-white/95 shadow-lg backdrop-blur-sm font-mono text-[11px] dark:border-neutral-700 dark:bg-neutral-900/95 dark:text-neutral-300">
			...
			<div className="space-y-3 p-3">
				{/* Zoom limits */}
				<div>
					<div className="mb-1 text-neutral-400 dark:text-neutral-500">Zoom Range</div>
					<div className="flex gap-2">
						<label className="flex flex-1 items-center gap-1">
							...
							<input
								type="number"
								step="0.01"
								className="w-full rounded border border-neutral-200 bg-neutral-50 px-1.5 py-0.5 text-right dark:border-neutral-600 dark:bg-neutral-800 dark:text-neutral-200"
								value={minZoom}
				...
				<div>
					<div className="mb-1 text-neutral-400 dark:text-neutral-500">Breakpoint Thresholds (screen px)</div>
				...
				{/* Actions */}
				<div className="flex gap-2 border-t border-neutral-100 pt-2 dark:border-neutral-700">
					<button
						type="button"
						className="flex-1 rounded bg-neutral-100 py-1 text-neutral-600 hover:bg-neutral-200 dark:bg-neutral-800 dark:text-neutral-300 dark:hover:bg-neutral-700"
				...
				<div className="border-t border-neutral-100 pt-2 dark:border-neutral-700">
					<div className="mb-1 text-neutral-400 dark:text-neutral-500">Stress Test</div>
					<div className="flex gap-2">
